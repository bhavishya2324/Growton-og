...
const testimonials: Testimonial[] = [
    ...
    },
    {
        ...
        role: 'Youtuber',
        image: 'sir.png',
        quote: ' The team was responsive, insightful, and genuinely invested in my success. If you are serious about scaling your educational content Growton delivers results where others just make promises.',
    },
    {
        name: 'Mahesh Bansal',
        role: 'Cafe Owner',
            ...
            <div className="py-16 md:py-32">
                <div className="mx-auto max-w-6xl px-6">
                    <div className="text-center">
                        <h2 className="text-title text-3xl font-semibold">Loved by the Clients ❤️</h2>
